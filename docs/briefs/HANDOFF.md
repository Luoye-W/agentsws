...
| 27 | WP143 DeepSeek 图片走 Files API 复用 + 推理内容回传（移植官方 dsh-llm-deepseek）；评估 API key 那一路改走 Messages | `WP143-deepseek-files-api.md` | `wp143-ds-files` · `wp/143-ds-files` | — | 待审（报告 docs/briefs/reports/WP143.md） |
