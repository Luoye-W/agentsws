...
| 15 | WP131 插件收尾六条（标题可选 / 列表页换算上云 / 自动评分接上 / 深链回本地页）+ 积分价目重算表 docs/77 | `WP131-plugin-followups-and-repricing.md` | 开源 `wp131-repricing` · `wp/131-repricing`；私有 `wp/131-plugin` | — | 进行中（Claude） |
