...
const zh: Table = {
  ...
  'position.connections.recommended': '推荐：没连有一块看不到',
  ...
  'seo.geo.enabled': '每周探测',
  'seo.geo.max': '每周最多问',
  'seo.geo.ask_this': '这一问要不要问',
  'seo.geo.add_placeholder': '加一个买家会问的问题',
  'seo.geo.add': '加一个',
  'seo.geo.save': '保存问题',
  'seo.run.daily': '现在读一遍 Search Console',
  'seo.run.weekly': '现在出周小结',
  'seo.run.done': '跑完了，看面板上的报告',
  ...
  'credits.tiers.failed': '建不了充值单：{msg}',

  // ── WP118（67 §3）红人营销增值服务：本地一份、云端一份 ──────────────
  'kol_cloud.title': '红人营销增值服务',
  'kol_cloud.hint':
    '买的不是备份：红人库在本地有一份、云端也有一份，两头都能改、双向同步。这是"红人营销以后不依赖这台机器也能跑"的地基。',
  'kol_cloud.price': '30 积分 / 月（= ¥30）',
  'kol_cloud.state.none': '还没开通',
  'kol_cloud.state.active': '生效中',
  'kol_cloud.state.grace': '欠费暂停',
  'kol_cloud.state.suspended': '欠费暂停',
  'kol_cloud.state.cancelling': '当期用完为止',
  'kol_cloud.none_note': '开通之后，红人库开始往云上同步；随时可以取消。',
  'kol_cloud.active_note': '当期到 {date}，到期自动续（那一期 30 积分）。',
  'kol_cloud.cancelling_note': '已点取消：用到 {date} 为止，之后不再扣积分。数据一条没动。',
  'kol_cloud.unpaid_note':
    '这一期的 30 积分没扣上，同步暂停到 {date}。**云上与本地的数据一条都没动**，充上值就自己接上。',
  'kol_cloud.not_linked': '先关联 agentsws 账号，才能开通这一项。',
  'kol_cloud.unreachable': '云上暂时联系不上，这一格的数字取不到。',
  'kol_cloud.counts': '云端 {cloud} 条 · 本地待推 {pending} 条',
  'kol_cloud.never_synced': '还没同步过',
  'kol_cloud.last_sync': '最近同步 {when}',
  'kol_cloud.subscribe': '开通',
  'kol_cloud.sync_now': '立即同步',
  'kol_cloud.cancel': '取消订阅',
  'kol_cloud.export': '导出云端这一份',
  'kol_cloud.delete': '删掉云端这一份',
  'kol_cloud.delete_confirm': '确定删掉云上这 {n} 条？本地这一份一条不动。',
  'kol_cloud.delete_yes': '确定删除',
  'kol_cloud.delete_no': '算了',
  'kol_cloud.subscribed': '开通好了，这一期扣了 30 积分。红人库开始同步。',
  'kol_cloud.cancelled': '已取消：当期用完为止，数据一条没动。',
  'kol_cloud.run_ok': '推上去 {pushed} 条，拉下来 {pulled} 条。',
  'kol_cloud.run_skipped': '云上有 {n} 条本地这一版还放不下（活动 / 候选池 / 备注）。',
  'kol_cloud.run_failed': '这一趟没同步成。改动都在本地排着队，一条没丢。',
  'kol_cloud.deleted': '云上那 {n} 条删掉了。本地这一份没动，订阅也没动。',
  'kol_cloud.exported': '导出好了（{n} 条），已下载到你电脑上。',
  'kol_cloud.conflict_resolved': '这一条处理完了。两个版本都还留着，导出时一起带走。',
  'kol_cloud.conflicts': '{n} 条同步冲突',
  'kol_cloud.conflict_note':
    '两台机器都改过同一条。当前值是赢的那一份；被盖掉的那一份也留着，你可以挑回来。',
  'kol_cloud.conflict_keep': '就用当前这份',
  'kol_cloud.conflict_pick': '挑回被盖掉的那份',
  'kol_cloud.kind.creator': '红人',
  'kol_cloud.kind.platform_account': '账号',
  'kol_cloud.kind.creator_contact': '联系方式',
  'kol_cloud.kind.collaboration': '合作',
  'kol_cloud.kind.deliverable': '交付物',
  'kol_cloud.kind.tracked_link': '追踪链接',
  'kol_cloud.kind.exchange': '往来信件',
  ...
  'kol.library.batch': '插件这一批（{n} 位）',
  'kol.library.batch.hint': '只列这一次在插件里收进来的人。',
  'kol.library.batch.empty': '这一批里没有这条渠道的人——可能收在别的渠道，或者这一批还没收完。',
  'kol.library.batch.all': '看全部',
  'kol.audit': '体检 {n}',
  'kol.detail.close': '收起',
  ...
  'data.route.enable': '启用',
  'data.byo.title': '自带数据接口（高级）',
  'data.byo.url': '服务地址',
  'data.byo.key': '密钥',
  'data.byo.key.set': '已设置（要换再填一次）',
  'data.byo.format': '返回格式：工坊公开约定（byo/v1）',
  'data.byo.test': '测试连接',
  'data.byo.save': '保存',
  'data.byo.remove': '拔掉',
  ...
  // 两条用词纪律：
  //
  // 1. 「未找到，请补充」**不写成「无」**。用户看不出"这个品牌没有这一项"
  //    和"我们没抓到"的区别，而那两件事他要做的动作完全不同。
  // 2. 冲突那一行不说哪个对。手册与官网不一样时我们没资格替他判，
  ...
  'design.md.section.spacing': '间距',
  'design.md.section.rounded': '圆角',
  'design.md.section.components': '组件',
  'design.md.section.logo': 'logo',
  'design.md.preview.light': '浅底',
  'design.md.preview.dark': '深底',
  'design.md.tab.visual': '可视化',
  'design.md.tab.source': '原文',
  'design.md.tab.history': '版本',
  'design.md.paste': '整份替换',
  'design.md.save': '保存',
  'design.md.saved': '已保存（第 {revision} 版）',
  'design.md.download': '下载 DESIGN.md',
  'design.md.rev.site_extract': '从官网抓的',
  'design.md.rev.file_extract': '从手册读的',
  'design.md.rev.manual_edit': '手改的',
  'design.md.rev.paste_replace': '整份替换',
  ...
  'nav.chat': '聊天沙盒',
  'chat.title': '聊天沙盒',
  'chat.window.entry.title': '网站在线客服',
  'chat.window.entry.subtitle': '装到网站上的聊天窗：外观、嵌入代码、转发方式与进行中的对话。',
  'chat.window.entry.open': '去设置聊天窗',
  'chat.window.appearance': '外观',
  'chat.window.accent': '主色',
  'chat.window.greeting': '欢迎语',
  'chat.window.greeting.placeholder': '你好，有什么可以帮你的？',
  'chat.window.save': '保存',
  'chat.window.origins': '允许的网站',
  'chat.window.origins.hint': '逗号分隔；留空一个都不放行（默认安全）。',
  'chat.window.assist_wait': '求助等待时长',
  'chat.window.assist_wait.option': '{n} 秒',
  'chat.window.assist_wait.hint':
    '超时要人拍板的问题，访客最多等这么久，然后自动转邮件跟进。改了只影响之后的新求助。',
  ...
  'chat.window.relay.usage': '本月对话 {count} / {limit}',
  'chat.window.relay.self': '自建转发（你自己部署的转发器）',
  ...
  'chat.window.hosted.sleeping': '云端暂时没在跑，正在重新拉起',
  'chat.window.hosted.grace': '积分不够，宽限中（云端还在值守，充值后自动续上）',
  'chat.window.hosted.suspended': '宽限到期，已停；30 天内重新开通可接着用',
  'chat.window.hosted.heartbeat': '{n} 分钟前还在线',
  'chat.window.hosted.cancelling': '已取消，用到 {date} 为止',
  'chat.window.hosted.subscribe': '开通（30 积分 / 月）',
  'chat.window.hosted.cancel': '取消（当期用完为止）',
  'chat.window.hosted.seed': '用本机这一份更新云端',
  'chat.window.hosted.bring_home': '把云端那一份取回来',
  'chat.window.embed': '嵌入代码（贴到网站 </body> 前）',
  'chat.window.embed.copy': '复制',
  'chat.window.preview': '实时预览',
  'chat.window.conversations': '进行中的对话',
  'chat.window.conversations.empty': '还没有访客对话。装好嵌入代码后，对话会出现在这里。',
  'chat.window.teach.placeholder': '教 AI 怎么答…（客户看不到这句话）',
  'chat.window.teach.send': '教一句',
  'chat.window.teach.hint': 'AI 会用客户的语言改写后以 AI 口吻回复；结束时可以沉淀成知识。',
  'chat.session.open': 'AI 在答',
  'chat.session.assist_requested': '等你',
  'chat.session.assist_answered': '已回复',
  'chat.session.human_takeover': '已转邮件',
  'chat.session.email_follow_up': '已转邮件跟进',
  'chat.session.closed': '已结束',
  'messages.source.chat': '只看聊天留言',
  ...
  'cu.stop': '停止',
  // WP156（36 §7 第三档）：教程文章——卡片上的「看教程」与右栏「教程」面板
  'rail.panel.help': '教程',
  'help.open': '看教程',
  'help.index': '全部教程',
  'help.missing': '这篇教程还没写。',
  'help.agentsws-credits.title': 'Agents 工坊官方接口与积分',
  'help.model-deepseek.title': '接 DeepSeek（账户登录 / API key）',
  'help.model-openai-compatible.title': '接 OpenAI 兼容服务（Kimi、智谱、Ollama…）',
  'help.model-bailian.title': '接阿里云百炼（三个方案怎么选）',
  'help.model-openai.title': '接 OpenAI / ChatGPT 订阅',
  'help.model-anthropic.title': '接 Anthropic / Claude 订阅',
  'help.browser.title': '让 AI 用浏览器（四种方式）',
  'help.computer-use.title': '让 AI 操作这台电脑',
  'help.search-data.title': '搜索数据接口',
...
const en: Table = {
  ...
  'highlight.design_note': 'Brand spec',
  'nav.skills': 'Skills',
  'skills.title': 'Skills',
  ...
  'position.connections.recommended': 'Recommended — part of the panel needs it',
  ...
  'seo.geo.enabled': 'Weekly probing',
  'seo.geo.max': 'At most',
  'seo.geo.ask_this': 'Ask this one',
  'seo.geo.add_placeholder': 'Add a question buyers ask',
  'seo.geo.add': 'Add',
  'seo.geo.save': 'Save questions',
  'seo.run.daily': 'Read Search Console now',
  'seo.run.weekly': 'Run the weekly summary now',
  'seo.run.done': 'Done — see the reports on the panel',
  ...
  'category.page_seo': 'Page title & opening',
  ...
  'credits.tiers.failed': "Couldn't create the order: {msg}",

  // ── WP118 (67 §3) Influencer marketing add-on: one copy here, one in the cloud ──
  'kol_cloud.title': 'Influencer marketing add-on',
  'kol_cloud.hint':
    'Not a backup: your creator library lives here and in the cloud, both editable, syncing both ways. This is the ground work for running influencer marketing without this machine.',
  'kol_cloud.price': '30 credits / month (CNY 30)',
  'kol_cloud.state.none': 'Not started',
  'kol_cloud.state.active': 'Active',
  'kol_cloud.state.grace': 'Paused (unpaid)',
  'kol_cloud.state.suspended': 'Paused (unpaid)',
  'kol_cloud.state.cancelling': 'Until period ends',
  'kol_cloud.none_note': 'Once started, your creator library syncs to the cloud. Cancel any time.',
  'kol_cloud.active_note': 'This period runs to {date}, then renews (30 credits).',
  'kol_cloud.cancelling_note':
    'Cancelled: usable until {date}, no further charges. No data touched.',
  'kol_cloud.unpaid_note':
    "This month's 30 credits didn't go through, so syncing is paused until {date}. **Nothing was deleted, here or in the cloud** — top up and it resumes by itself.",
  'kol_cloud.not_linked': 'Link your agentsws account first, then you can start this.',
  'kol_cloud.unreachable': "Can't reach the cloud right now, so these numbers are unavailable.",
  'kol_cloud.counts': '{cloud} in the cloud · {pending} waiting here',
  'kol_cloud.never_synced': 'Never synced yet',
  'kol_cloud.last_sync': 'Last synced {when}',
  'kol_cloud.subscribe': 'Start',
  'kol_cloud.sync_now': 'Sync now',
  'kol_cloud.cancel': 'Cancel subscription',
  'kol_cloud.export': 'Export the cloud copy',
  'kol_cloud.delete': 'Delete the cloud copy',
  'kol_cloud.delete_confirm':
    'Delete those {n} rows in the cloud? The copy on this machine stays untouched.',
  'kol_cloud.delete_yes': 'Delete',
  'kol_cloud.delete_no': 'Never mind',
  'kol_cloud.subscribed': 'Started — 30 credits charged for this period. Syncing now.',
  'kol_cloud.cancelled': 'Cancelled: usable until the period ends. No data touched.',
  'kol_cloud.run_ok': 'Pushed {pushed}, pulled {pulled}.',
  'kol_cloud.run_skipped':
    '{n} rows in the cloud have no home in this version yet (campaigns / candidate pools / notes).',
  'kol_cloud.run_failed':
    "That sync didn't go through. Everything is still queued here — nothing lost.",
  'kol_cloud.deleted':
    'Deleted those {n} rows in the cloud. The local copy and the subscription are untouched.',
  'kol_cloud.exported': 'Exported ({n} rows) and downloaded to your computer.',
  'kol_cloud.conflict_resolved': 'Sorted. Both versions are kept and come along in the export.',
  'kol_cloud.conflicts': '{n} sync conflicts',
  'kol_cloud.conflict_note':
    'Two machines changed the same row. The current value is the winner; the other one is kept and you can pick it back.',
  'kol_cloud.conflict_keep': 'Keep current',
  'kol_cloud.conflict_pick': 'Pick the other one',
  'kol_cloud.kind.creator': 'Creator',
  'kol_cloud.kind.platform_account': 'Account',
  'kol_cloud.kind.creator_contact': 'Contact',
  'kol_cloud.kind.collaboration': 'Collaboration',
  'kol_cloud.kind.deliverable': 'Deliverable',
  'kol_cloud.kind.tracked_link': 'Tracked link',
  'kol_cloud.kind.exchange': 'Message',
  ...
  'kol.library.batch': 'This plugin batch ({n})',
  'kol.library.batch.hint': 'Only the creators you just captured with the plugin.',
  'kol.library.batch.empty':
    'No one from this batch on this channel — they may be on another channel, or the batch is still uploading.',
  'kol.library.batch.all': 'Show all',
  'kol.audit': 'Audit {n}',
  ...
  'data.route.title': 'Where data comes from (tried in order)',
  ...
  'data.route.enable': 'Enable',
  'data.byo.title': 'Bring your own data service (advanced)',
  'data.byo.url': 'Service URL',
  'data.byo.key': 'API key',
  'data.byo.key.set': 'Set (fill again to replace)',
  'data.byo.format': 'Response format: Workshop open convention (byo/v1)',
  ...
  'design.md.conflict.file': 'From the brand book',
  ...
  'design.md.section.spacing': 'Spacing',
  'design.md.section.rounded': 'Corners',
  'design.md.section.components': 'Components',
  'design.md.section.logo': 'Logo',
  'design.md.preview.light': 'On light',
  'design.md.preview.dark': 'On dark',
  'design.md.tab.visual': 'Visual',
  'design.md.tab.source': 'Source',
  'design.md.tab.history': 'History',
  'design.md.paste': 'Replace whole file',
  'design.md.save': 'Save',
  'design.md.saved': 'Saved (revision {revision})',
  'design.md.download': 'Download DESIGN.md',
  'design.md.rev.site_extract': 'Pulled from the website',
  'design.md.rev.file_extract': 'Read from a brand book',
  'design.md.rev.manual_edit': 'Edited by hand',
  'design.md.rev.paste_replace': 'Whole file replaced',
  ...
  'chat.window.entry.title': 'Website live chat',
  'chat.window.entry.subtitle':
    'The chat widget on your site: appearance, embed code, relay mode, and ongoing conversations.',
  'chat.window.entry.open': 'Set up live chat',
  'chat.window.appearance': 'Appearance',
  'chat.window.accent': 'Accent color',
  'chat.window.greeting': 'Greeting',
  'chat.window.greeting.placeholder': 'Hi! How can we help?',
  'chat.window.save': 'Save',
  'chat.window.origins': 'Allowed websites',
  'chat.window.origins.hint': 'Comma separated; empty means none may embed (safe default).',
  'chat.window.assist_wait': 'Handoff wait time',
  'chat.window.assist_wait.option': '{n} sec',
  'chat.window.assist_wait.hint':
    'When the AI needs you, the visitor waits at most this long before we switch to email follow-up. Changes only affect new requests.',
  'chat.window.relay': 'Relay mode',
  ...
  'chat.window.relay.usage': 'Conversations this month: {count} / {limit}',
  'chat.window.relay.self': 'Self-hosted relay (your own deployment)',
  ...
  'chat.window.hosted.sleeping': 'Not running right now, restarting',
  'chat.window.hosted.grace': 'Low on credits: grace period (still on duty until you top up)',
  'chat.window.hosted.suspended':
    'Grace period over, stopped; re-subscribe within 30 days to pick up where it left off',
  'chat.window.hosted.heartbeat': 'Last seen {n} min ago',
  'chat.window.hosted.cancelling': 'Cancelled, runs until {date}',
  'chat.window.hosted.subscribe': 'Subscribe (30 credits / month)',
  'chat.window.hosted.cancel': 'Cancel (runs to period end)',
  'chat.window.hosted.seed': 'Update the cloud with this computer',
  'chat.window.hosted.bring_home': 'Bring the cloud copy home',
  'chat.window.embed': 'Embed code (paste before </body>)',
  'chat.window.embed.copy': 'Copy',
  'chat.window.preview': 'Live preview',
  'chat.window.conversations': 'Ongoing conversations',
  'chat.window.conversations.empty':
    'No visitor conversations yet. Once the embed code is live, they show up here.',
  'chat.window.teach.placeholder': 'Teach the AI how to reply… (the visitor never sees this)',
  'chat.window.teach.send': 'Teach',
  'chat.window.teach.hint':
    'The AI rewrites it in the visitor\u2019s language and replies as itself; you can sediment it as knowledge afterwards.',
  'chat.session.open': 'AI answering',
  'chat.session.assist_requested': 'Waiting for you',
  'chat.session.assist_answered': 'Replied',
  'chat.session.human_takeover': 'Moved to email',
  'chat.session.email_follow_up': 'Moved to email',
  'chat.session.closed': 'Closed',
  'messages.source.chat': 'Chat messages only',
  ...
  'cu.stop': 'Stop',
  // WP156 (36 §7, third tier): tutorial articles — "Tutorial" on cards and the right-rail panel
  'rail.panel.help': 'Tutorials',
  'help.open': 'Tutorial',
  'help.index': 'All tutorials',
  'help.missing': 'This tutorial has not been written yet.',
  'help.agentsws-credits.title': 'Agents Workshop models and credits',
  'help.model-deepseek.title': 'Connect DeepSeek (account sign-in / API key)',
  'help.model-openai-compatible.title': 'Connect an OpenAI-compatible service (Kimi, GLM, Ollama…)',
  'help.model-bailian.title': 'Connect Alibaba Cloud Model Studio (which plan)',
  'help.model-openai.title': 'Connect OpenAI / a ChatGPT subscription',
  'help.model-anthropic.title': 'Connect Anthropic / a Claude subscription',
  'help.browser.title': 'Let AI use a browser (four ways)',
  'help.computer-use.title': 'Let AI operate this computer',
  'help.search-data.title': 'Search data APIs',
